...
export const Modal = {
  title: 'Title',
  body: <div><strong>Strong</strong> body!</div>,
  active: true,
  showFooter: true,
  centerContent: true,
...
export const WordCloud = {
  data: [
    ...
    { text: 'guards', size: 2 },
    { text: 'Alberta', size: 2 },
    { text: 'searches', size: 2 },
    { text: 'York', size: 2 },
    { text: 'people', size: 2 },
    { text: 'making', size: 2 },
    { text: 'painkiller', size: 2 },
    { text: 'Toronto', size: 2 },
    { text: 'officer', size: 2 },
    { text: 'hysteria', size: 2 },
    { text: 'doses', size: 2 },
    { text: 'joke', size: 2 },
    { text: 'tPlvoHGsVc', size: 2 },
    { text: 'figures', size: 2 },
    { text: 'police', size: 2 },
    { text: 'suspected', size: 2 },
    { text: 'Piedmont', size: 2 },
    { text: 'Investment', size: 2 },
    { text: 'Advisors', size: 2 },
    { text: 'stake', size: 2 },
    { text: 'quarter', size: 2 },
    { text: 'Securities', size: 2 },
    { text: 'Exchange', size: 2 },
    { text: 'Commission', size: 2 },
    { text: 'Buckingham', size: 2 },
    { text: 'issued', size: 2 },
    { text: 'Monday', size: 2 },
    { text: 'earnings', size: 2 },
    { text: 'Orazio', size: 2 },
    { text: 'Associates', size: 2 },
    { text: 'Aerospace', size: 2 },
    { text: 'carfentanil', size: 2 },
    { text: 'Task', size: 1 },
    { text: 'Force', size: 1 },
  ],
}
